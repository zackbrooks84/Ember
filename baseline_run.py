...
it reads ``baseline_run.csv`` (no anchors or memory) from the project
root and ``tests/data/__metrics___WITH_anchors.csv`` (anchored) and
reports the mean ``ξ`` values and their difference.
"""
